...
function createData(id, name, gender, mark, city, ranking) {
  return { id, name, gender, mark, city, ranking };
}
...
export default function EnhancedTable(props) {
  ...
  console.log('studentList_', studentList);
  // const rows = [
  //   createData(124, 'Duong The Tao', 'Male', 8, 'Ha Noi', '1st'),
  //   createData(125, 'Phan Thi Hoa', 'Male', 8, 'Ha Noi', '1st'),
  // ];
