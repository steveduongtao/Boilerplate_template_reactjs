...
import { default as React, memo, useEffect, useRef } from 'react';
...
import makeSelectDownloadFile from './selectors';
...
export function DownloadFile() {
  useInjectReducer({ key: 'downloadFile', reducer });
  useInjectSaga({ key: 'downloadFile', saga });
...
const mapStateToProps = createStructuredSelector({
  downloadFile: makeSelectDownloadFile(),
});
